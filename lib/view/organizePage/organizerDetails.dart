...
import 'package:contest_hub/view/organizePage/moreInfo.dart';
...
class AboutOrganizer extends StatefulWidget {
  const AboutOrganizer({Key? key}) : super(key: key);

  @override
  State<AboutOrganizer> createState() => _AboutOrganizerState();
}

class _AboutOrganizerState extends State<AboutOrganizer> {
  String item = "Select";
                              ...
                              child: DropdownButtonHideUnderline(
                                child: DropdownButton(
                                    ...
                                    items: [
                                      ...
                                      DropdownMenuItem(
                                        child: Text("Product Manufacture"),
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                hintText: "Enter name of Organizer",
                            ...
                            child: Container(
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                    ...
                                    hintText:
                                        "Enter company description (or URL site)",
                                    border: OutlineInputBorder(
                                        borderRadius:
